...
graph2<-tibble(years,percent_16,percent_18,percent_21,percent_30) %>% 
  ...
  labs(title="Percent of Total Deaths that are Alcohol Related from ages 16-30, from 1982-2019", subtitle="Around 21 years of age is when the percentage is the highest through all the years",x="Year",y="Percent of Total Vehicle Deaths thatare \n alcohol related (BAC >= 0.08)")
